...
export const PROJECTS_ZH: Project[] = [
  ...
  { num: "02", title: "全球化企业设备管理平台", en: "Global Device Management", tags: ["ToB复杂系统", "0-1产品设计", "场景化设计"], href: true, desc: "全球化企业设备管理平台提供端到端行业移动管理解决方案，为企业提供自动部署、设备管控、应用管控、内容配置、设备安全与防护、以及高质量企业移动办公解决方案。" },
